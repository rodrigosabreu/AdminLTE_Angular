...
@Component({
  selector: 'app-ordens-list',
  templateUrl: './ordens-list.component.html',
  styleUrls: ['./ordens-list.component.css']
})



export class OrdensListComponent implements AfterViewInit {
